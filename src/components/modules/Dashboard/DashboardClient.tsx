  ...
  return (
    <div className="p-6 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="shadow-md rounded-lg p-6 border border-gray-200">
        ...
        <div className="shadow-md rounded-lg p-6 border border-gray-200">
          ...
          <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-blue-50 rounded px-3 pt-5 pb-7  text-center">
              <p className="dark:text-gray-600 text-2xl font-bold">{(user.travelInterests ?? []).length}</p>
              <p className="text-gray-600 text-sm">Travel Interests</p>
            </div>
            <div className="bg-green-50 rounded p-3 text-center">
              <p className="dark:text-gray-600 text-2xl font-bold">{(user.visitedCountries ?? []).length}</p>
