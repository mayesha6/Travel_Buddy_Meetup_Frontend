...
export default function ChangePasswordPage() {
  ...
  return (
    <>
      <SEO
        title="Change Password - Keep Your Account Secure"
        description="Update your account password easily and ensure your account stays protected. Quick and secure password management."
      />
